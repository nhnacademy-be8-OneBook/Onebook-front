    ...
    public SecurityFilterChain devSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(formLogin ->
                formLogin
                        ...
                        .successHandler(new AuthSuccessHandler(authFeignClient, memberClient)) // 성공 핸들러
        ...
        http.authorizeHttpRequests(authRequest -> {
            authRequest
                    .requestMatchers("/", "/login", "/public/**",
                            ...
                            "/style.css", "/dormant-account/**", "/dooray-message-authentication", "/my/point/mypoints") // 포인트 페이지 허용
